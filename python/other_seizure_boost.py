...
def create_simple_csv():
    ...
    files = sorted(glob.glob("/home/jirka/data/kaggle_seisure_prediction_2016/train_*/*.mat"))
    ...
    files = sorted(glob.glob("/home/jirka/data/kaggle_seisure_prediction_2016/test_*/*.mat"))
